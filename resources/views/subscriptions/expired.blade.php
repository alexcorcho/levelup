...
@section('content')
    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Suscripciones caducadas
                <small>Detalles de todas las Suscripciones caducadas</small>
            </h1>
            ...
            <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span data-toggle="counter" data-start="0"
                ...
                <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">Suscripciones caducadas</small>
            </h1>
            @endpermission
        </div>
                            ...
                            <div class="panel-head font-size-15">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-sm-2">
                                            {!! Form::label('sort_direction','Ordenar') !!}
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="gymie_paging_info">
                                            ...
                                            Mostrando página {{ $allExpired->currentPage() }} of {{ $allExpired->lastPage() }}
                                        </div>
                                    </div>
