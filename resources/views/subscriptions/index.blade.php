    ...
    <div class="rightside bg-grey-100">
        ...
        <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
            ...
            <h1 class="page-title no-line-height">Subscriptions
                ...
                <a href="{{ action('SubscriptionsController@create') }}" class="page-head-btn btn-sm btn-primary active" role="button">Agregar</a>
                                    ...
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-xs-2">
                                            ...
                                            <select id="plan_name" name="plan_name" class="form-control selectpicker show-tick">
                                                ...
                                                <option value="0" {{ (old('plan_name') == "" ? "selected" : "") }}>Todo</option>
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="gymie_paging_info">
                                            <!-- TO DO -->
                                            Mostrando página {{ $subscriptions->currentPage() }} of {{ $subscriptions->lastPage() }}
                                        </div>
                                    </div>
