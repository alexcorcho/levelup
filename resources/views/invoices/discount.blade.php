                ...
                <div class="col-md-12">
                    <div class="panel no-border">
                        <div class="panel-title">
                            <div class="panel-head font-size-20">Ingrese los detalles del descuento</div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {!! Form::label('subscription_amount','Cuota de suscripción') !!}
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {!! Form::label('additional_fees','Cuotas adicionales') !!}
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-usd" ></i></div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select id="discount_percent" name="discount_percent" class="form-control selectpicker show-tick show-menu-arrow">
                                            ...
                                            @endforeach
                                            <option value="custom" {{ ($invoice->discount_percent == "custom" ? "selected" : "") }}>Personalizado</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-4">
