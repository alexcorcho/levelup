...
class SubscriptionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            // Función auxiliar para establecer el estado de pago
            ...
            foreach ($request->plan as $plan) {
                ...
                //Agregar suscripción a la factura (Detalles de la factura)
            ...
            // Establezca el estado de suscripción de la suscripción 'Renovada' a por Renovar
            ...
            DB::commit();
            flash()->success('La suscripción se creó correctamente');

            return redirect(action('SubscriptionsController@index'));
        } catch (\Exception $e) {
            DB::rollback();
            flash()->error('Error al crear la suscripción');
    ...
    public function cancelSubscription($id)
    {
        ...
        try {
            ...
            DB::commit();
            flash()->success('La suscripción se canceló con éxito.');

            return redirect('subscriptions/expired');
        } catch (Exception $e) {
            DB::rollback();
            flash()->error('Error al cancelar la suscripción');
    ...
    public function modify($id, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            flash()->success('La suscripción se modificó correctamente.');

            return redirect(action('MembersController@show', ['id' => $subscription->member_id]));
        } catch (\Exception $e) {
            DB::rollback();
            flash()->error('Error al cambiar la suscripción');
