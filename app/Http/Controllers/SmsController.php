<?php
// TODO ESTE CODIGO ES TOMADO DE INTERNET DE MANERA LITERARL APARA MANEJO DE SMS 
...
class SmsController extends Controller
{
    ...
    public function triggerUpdate(Request $request)
    {
        ...
        flash()->success('Los activadores de mensajes se actualizaron correctamente');
    ...
    public function storeEvent(Request $request)
    {
        ...
        flash()->success('El evento se creó con éxito.');
    ...
    public function updateEvent($id, Request $request)
    {
        ...
        $event->updatedBy()->associate(Auth::user());
        $event->save();
        flash()->success('Los detalles de los eventos de SMS se actualizaron correctamente');
    ...
    public function destroyEvent($id)
    {
        ...
        flash()->success('El evento de SMS se eliminó correctamente');
    ...
    public function shoot(Request $request)
    {
        ...
        flash()->success('El mensaje ha sido enviado exitosamente');
    ...
    public function logRefresh()
    {
        ...
        flash()->success('Los registros de SMS se han actualizado.');
